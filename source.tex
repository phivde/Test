...
\usepackage{amsmath}	
\usepackage[box,noshuffle,completemulti]{automultiplechoice}	
% Test de changement
\renewcommand{\rmdefault}{\sfdefault}	

%Tweak margins here if desired%\geometry{hmargin=3cm,headheight=2cm,headsep=.3cm,footskip=1cm,top=3.5cm,bottom=2.5cm}
